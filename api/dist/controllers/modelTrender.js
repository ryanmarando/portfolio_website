...
async function findLatestRunForModel(model) {
...
export const getModelRun = async (req, res) => {
    const baseUrl = "https://nomads.ncep.noaa.gov/pub/data/nccf/com/gfs/prod/gfs.20250503/00/atmos/";
    try {
