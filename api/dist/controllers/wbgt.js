...
export const getWBGT = async (req, res) => {
    ...
    try {
        ...
        const city = stationData["properties"]["relativeLocation"]["properties"]["city"];
        const state = stationData["properties"]["relativeLocation"]["properties"]["state"];
        ...
        const stationForecastGridData = await stationForecastGridDataResponse.json();
        const wbgtForecast = stationForecastGridData?.properties?.wetBulbGlobeTemperature;
        if (!wbgtForecast) {
